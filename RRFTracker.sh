...
case "$1" in
    start)
        ...
        nohup python $PATH_SCRIPT --i2c-port 0 --display ssd1327 --display-height 128 --follow TEC  > $PATH_PID/RRFTracker_Spotnik_0.log 2>&1 & echo $! > $PATH_PID/RRFTracker_Spotnik_0.pid

...
def tot(draw, legacy, start, current, position):
    ...
    for c in tmp:
        msg += chr(int(c))
    legacy.text(draw, (60, position + 2), msg, fill='white', font=s.SMALL_BITMAP_FONT)
...
def histogram(draw, legacy, position):
    ...
    for i in xrange(57, 41, -2):
        draw.line((0, i, 0, i), fill='white')
        draw.line((127, i, 127, i), fill='white')

...
case "$1" in
    start)
        ...
        nohup python $PATH_SCRIPT --i2c-port 1 --display ssd1327 --display-height 128 --display-theme theme_gray.cfg --follow F4HWN > $PATH_PID/RRFTracker_Spotnik_1.log 2>&1 & echo $! > $PATH_PID/RRFTracker_Spotnik_1.pid
        ;;
    stop) 
